namespace ZaloSDK.Config
{
    public class APIConfig
    {
        ...
        public static readonly string USER_AGENT = "zalosdk/7.0 DotNet Open API Java SDK";
        public static readonly string SDK_VERSION = "DotNet 7.0";
        public static readonly string SDK_SOURCE = "DotNetSDK-7.0";
        public static readonly Dictionary<string, string> DEFAULT_HEADER = createDefaultHeader();

        public static Dictionary<string, string> createDefaultHeader()
        {
