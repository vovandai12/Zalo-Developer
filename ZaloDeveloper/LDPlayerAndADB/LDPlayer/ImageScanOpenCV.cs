...
namespace LDPlayerAndADB.LDPlayer
{
    public static class ImageScanOpenCV
    {
        ...
        {
            Image<Bgr, byte> source = new Image<Bgr, byte>(mainBitmap.Width, mainBitmap.Height);
            Image<Bgr, byte> template = new Image<Bgr, byte>(mainBitmap.Width, mainBitmap.Height);
        ...
        public static void TestDilate(Bitmap bmp)
        {
            for (; ; )
            {
                Image<Gray, byte> imgOld = new Image<Gray, byte>(bmp.Width, bmp.Height);
                imgOld.Save("old.png");
        ...
        {
            Image<Gray, byte> img = new Image<Gray, byte>(bmp.Width, bmp.Height);
